...
const PanelIcons = {
  Templates: {
    render: () => <i className="icon-templates"></i>,
  },
  Elements: {
    render: () => <i className="icon-elements"></i>,
  },
  Uploads: {
    render: () => <i className="icon-gallery"></i>,
  },
  // videos: {
  //   render: () => <VideoIcon />,
  // },
  Text: {
    render: () => <i className="icon-textblock"></i>,
  },
  Background: {
    render: () => <i className="icon-copy"></i>,
  },
}
