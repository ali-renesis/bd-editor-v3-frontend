...
const baseURL = `https://bd-be-stag.renesistechdemo.com/api/v1`
// const baseURL = `http://localhost:5081/api/v1`
export class HttpService {
     ...
     * @return Promise
     */
    protected post = (url: string, body: any, options = {}): Promise<any> => axios.post(`${baseURL}/${url}`, body, {
        ...options,
        cancelToken: this.source.token,
    });
